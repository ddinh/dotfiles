...
(defun dotspacemacs/layers ()
  "Configuration declaration. Layers
...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(doom-themes deft)
...
you should place your code here."
  ...
  ;; Change powerline separator to arrow
  ...
  (define-key evil-hybrid-state-map (kbd "C-v") 'clipboard-yank)
  (define-key evil-hybrid-state-map (kbd "C-s") 'save-buffer)

  (evil-define-key 'normal lsp-mode-map "gd" 'lsp-goto-type-definition)
  (evil-define-key 'normal lsp-mode-map "gr" 'xref-find-references)
  (evil-define-key 'normal lsp-mode-map ",s" 'helm-lsp-global-workspace-symbol)

  (spacemacs/set-leader-keys "s" 'helm-projectile-find-file)
  (spacemacs/set-leader-keys "d" 'projectile-dired)
  ...
  (spacemacs/set-leader-keys "an" 'bjm-deft)

  (defun clojure-send-form-to-repl ()
    (interactive)
    (if (string= "(" (clojure-char-at-point)) (evil-forward-char))
    (sp-end-of-sexp)
    (evil-append 1)
